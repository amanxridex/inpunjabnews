...
url = 'https://wyfodwmgosbubyonajjv.supabase.co/rest/v1/articles?id=not.is.null'
headers = {
...
data = json.dumps({'author': 'By Vicky Suri'}).encode('utf-8')
req = urllib.request.Request(url, data=data, headers=headers, method='PATCH')

try:
    with urllib.request.urlopen(req) as response:
        print("Successfully updated all articles to By Vicky Suri")
